...
export default function DashboardLayout({
  ...
  const selectedProjectId = useMemo(() => {
    if (manuallySelectedId && projects?.some(p => p.id === manuallySelectedId)) {
                ...
                <SheetContent side="left" className="w-72 p-0">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="space-y-2">
                      <p className="text-xs font-medium text-black/50 uppercase tracking-wide">Organization</p>
                      <OrganizationSwitcher />
                    </div>

                    {/* Mobile Project Selector */}
                    <div className="space-y-2">
                      <p className="text-xs font-medium text-black/50 uppercase tracking-wide">Project</p>
                      <DropdownMenu>
                    ...
                    {/* Mobile Navigation */}
                    <div className="space-y-2">
                      <p className="text-xs font-medium text-black/50 uppercase tracking-wide">Navigation</p>
